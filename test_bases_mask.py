...
def test_case1():
    x = return_base_mask("100T8B", "100T8B")
    assert x == "y100,I8"


def test_case1_picard():
    x = return_base_mask("100T8B", "100T8B", "picard")
    assert x == "100T8B"


def test_case2():
    x = return_base_mask("100T8B", "90T10S8B")
    assert x == "y90n10,I8"


def test_case2_picard():
    x = return_base_mask("100T8B", "90T10S8B", "picard")
    assert x == "90T10S8B"
...
def test_case4():
    x = return_base_mask("100T8B8B100T", "90T10S8B8B100T")
